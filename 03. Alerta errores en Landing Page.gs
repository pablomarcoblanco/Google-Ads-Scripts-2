...
* 3/11/2018
*
* Maintained By: Pablo Marco
* Based on Script from Brainlabs
*
* ChangeLog:
* No changes
*
...
function main() {
  ...
  var messagesToCheckFor = ["was not found", "This site can’t be reached",
  "error", "safari can't find the server", "Tenemos problemas para encontrar ese sitio"];
  // Add words or keywords that oly appear in "error landing pages"
  ...
  if(recipients.length > 0 && bad_urls.length > 0){
    ...
    var subject = "Verificación automática Landing Pages cuenta " + name;
    var body = 'Este es un mensaje automático del script de verificación de URLs. Las siguientes URLs contienen uno o varios de los siguientes mensajes de error. \n\nPhrases:\n"' + messagesToCheckFor.join('",\n"') + '"\n\nURLs:\n';
    body += bad_urls.join("\n");
